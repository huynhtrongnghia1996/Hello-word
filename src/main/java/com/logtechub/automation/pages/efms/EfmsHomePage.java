...
public class EfmsHomePage extends BasePage {
    ...
    public EfmsHomePage login(String username, String password) {
        firstVisible(USERNAME_SELECTORS, "eFMS username input").fill(username);
        firstVisible(PASSWORD_SELECTORS, "eFMS password input").fill(password);
        firstVisible(SUBMIT_SELECTORS, "eFMS login submit button").click();
        waitForDomContentLoaded();
        return this;
    }
